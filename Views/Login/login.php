...
<html lang="es">
    <head>
        ...
        <meta name="autor" content="jbonillaz">
        <meta name="theme-color" content="#009688">
        <link rel="shortcut icon" href="<?= media(); ?>/images/favicon.ico"> <!--icono para la pestaña del navegador-->
            <!-- Main CSS-->
    ...
    <body>
            ...
            <div class="login-box">
                ...
                <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input id="txtEmailReset" name="txtEmailReset" type="email" class="form-control" type="text" placeholder="Email">
                    </div>
                    <div class="form-group btn-container">
                        <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-sign-in-alt" ></i> Restablecer</button>
                    </div>
        ...
        <!-- libreria para las alertas suaves -->
